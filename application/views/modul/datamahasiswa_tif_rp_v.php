...
<table style="margin:50px auto; padding: 1px" border="10" cellpadding="10px">
			<thead>
				<tr>
			...
			<tbody>
				...
				foreach ($tampil as $tpl) {
					...
					echo "<td bgcolor='white'>".$tpl->int_npm."</td>";
					echo "<td bgcolor='white'>".$tpl->str_nama."</td>";
					echo "<td bgcolor='white'>Hapus</td></tr>";
					$no++;
				}
				 ?>
				 <td bgcolor='white'><button><a href="<?php echo base_url('Myadmin/tambahdatamahasiswa_tif_rp_v');?>">Tambah Data</a></button></td>
					</table>
